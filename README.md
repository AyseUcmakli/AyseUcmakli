...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?lines=I'm a Data Scientist!;I used it in my projects;Python|Matplotlib|Numpy|Pandas ;Seaborn|ScikitLearn|Tensorflow|Keras; Tableau|ML|DL|NLP ; !&font=Fira%20Code&center=true&width=380&height=50&duration=4000&pause=1000">
</p>
...
<p align="left">
  ...
  <a href="https://www.microsoft.com/en-us/sql-server" target="_blank"> <img src="https://img.shields.io/badge/Microsoft%20SQL%20Server-CC2927?style=for-the-badge&logo=microsoft-sql-server&logoColor=white" alt="MSSQL"> </a>
...
<p align="left">
  ...
  <a href="https://aws.amazon.com/sagemaker/" target="_blank"> <img src="https://img.shields.io/badge/SageMaker-FF9900?style=for-the-badge&logo=amazonsagemaker&logoColor=white" alt="SageMaker"> </a>
...
| # | Project Name | Technologies | Source Code |
| :---: | :--- | :--- | :---: |
| 01 | **Fraud Detection** | ML, ANN, SMOTE | [🔗 View](https://github.com/AyseUcmakli/Capstone_Fraud_Detection_Project) |
| 02 | **Churn Prediction** | ANN, Elbow Method, ML | [🔗 View](https://github.com/AyseUcmakli/Capstone_Project-Churn_Prediction) |
| 03 | **Customer Segmentation** | RFM, K-Means, Cohort | [🔗 View](https://github.com/AyseUcmakli/Customer_segmentation_RFM_Kmeans_Cohort_Analysis) |
| 04 | **Soldier Race Classification**| XGBoost, SVM, SHAP | [🔗 View](https://github.com/AyseUcmakli/Machine_Learning/blob/main/ML_Soldier_Race_Project/soldier_race_project_solution.ipynb) |
| 05 | **Auto Scout Price Prediction**| Regression, EDA, Python | [🔗 View](https://github.com/AyseUcmakli/ML_Auto_scout_project_1) |
| 06 | **Bus Demand Forecasting** | Time Series (ARIMA) | [🔗 View](https://github.com/AyseUcmakli/Forecasting-Bus-Demand-in-Banana-Republic-Municipalities) |
| 07 | **Dog Breed Classification** | CNN, Transfer Learning | [🔗 View](https://github.com/AyseUcmakli/Deep_Learning/tree/main/Dog_Classification) |
| 08 | **SQL & Tableau RFM** | SQL & Tableau | [SQL](https://github.com/AyseUcmakli/SQL/blob/main/RFM_Analysis/RFM_Analysis.sql) / [Tableau](https://github.com/AyseUcmakli/TABLEAU/blob/main/RFM_Analysis/Customer_purchasing_Habits.twbx) |
| 09 | **Sentiment Analysis** | BERT, DistilBERT, NLP | *In Progress* |
